...
//@PropertySource(value = "classpath:config/${config.file}.yml", factory = YamlPropertySourceFactory.class)
@PropertySource(value = "classpath:config/sparta-dev4.yml", factory = YamlPropertySourceFactory.class)
@Data
public class Config {
